...
struct ContentView: View {
    var body: some View {
        ...
        TabView {
            ...
            Text(" و موضوعك خالص")                           .multilineTextAlignment(.center)
                            .foregroundColor(.secondary)
            ...
            Image("display").resizable()
                ...
                .foregroundColor(.teal)
                Text("لا و تقدر تتواصل دايركت مع المسؤلين اذا توهقت !").font(.title).bold().frame(height: 150).padding(.horizontal, 1)
                
            Text("مو قلتلك موضوعك خالص؟")                           .multilineTextAlignment(.center)
                            .foregroundColor(.secondary)
